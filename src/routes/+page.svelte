...
<main
	id="main-content"
	class="relative z-10 mt-[100dvh] min-h-screen w-full rounded-t-[28px] sm:rounded-t-[44px] lg:rounded-t-[52px] bg-white dark:bg-black shadow-[0_-10px_30px_rgba(0,0,0,0.1)] sm:shadow-[0_-25px_60px_rgba(0,0,0,0.15)] sm:transition-shadow sm:duration-500"
>
